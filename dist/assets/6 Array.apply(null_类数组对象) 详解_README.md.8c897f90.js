import{_ as n,o as s,c as a,Q as e}from"./chunks/framework.9cedb9c5.js";const g=JSON.parse('{"title":"关于Array.apply(null,类数组对象)","description":"","frontmatter":{},"headers":[],"relativePath":"6 Array.apply(null,类数组对象) 详解/README.md","filePath":"6 Array.apply(null,类数组对象) 详解/README.md"}'),l={name:"6 Array.apply(null,类数组对象) 详解/README.md"},p=e(`<h1 id="关于array-apply-null-类数组对象" tabindex="-1">关于Array.apply(null,类数组对象) <a class="header-anchor" href="#关于array-apply-null-类数组对象" aria-label="Permalink to &quot;关于Array.apply(null,类数组对象)&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">let arr1 = new Array(2)</span></span>
...
<span class="line"><span style="color:#e1e4e8;"> * */</span></span>
<span class="line"><span style="color:#e1e4e8;">var arr3 = Array.apply(null, {length: 2}).map(function (currentValue, index, array) {</span></span>
<span class="line"><span style="color:#e1e4e8;">  return index</span></span>
<span class="line"><span style="color:#e1e4e8;">})</span></span>
<span class="line"><span style="color:#e1e4e8;">console.log(arr3)</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">let arr1 = new Array(2)</span></span>
...
<span class="line"><span style="color:#24292e;"> * */</span></span>
<span class="line"><span style="color:#24292e;">var arr3 = Array.apply(null, {length: 2}).map(function (currentValue, index, array) {</span></span>
<span class="line"><span style="color:#24292e;">  return index</span></span>
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">console.log(arr3)</span></span></code></pre></div>`,2),r=[p];function o(c,t,i,y,d,u){return s(),a("div",null,r)}const _=n(l,[["render",o]]);export{g as __pageData,_ as default};
