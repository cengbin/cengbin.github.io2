import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.9cedb9c5.js";const w=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"45 安全沙箱(Sandboxes)/README.md","filePath":"45 安全沙箱(Sandboxes)/README.md"}'),l={name:"45 安全沙箱(Sandboxes)/README.md"},p=e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">function foo(){</span></span>
...
<span class="line"><span style="color:#24292e;">    \`)</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">  fun.call(proxy)</span></span></code></pre></div>`,17),o=[p];function c(t,r,i,y,d,h){return n(),a("div",null,o)}const g=s(l,[["render",c]]);export{w as __pageData,g as default};
