import{_ as s,o as a,c as e,Q as n}from"./chunks/framework.9cedb9c5.js";const h=JSON.parse('{"title":"Element-ui el-dialog组件应用总结","description":"","frontmatter":{},"headers":[],"relativePath":"53 如何写CRUD页面总结/README.md","filePath":"53 如何写CRUD页面总结/README.md"}'),l={name:"53 如何写CRUD页面总结/README.md"},t=n(`<h1 id="element-ui-el-dialog组件应用总结" tabindex="-1">Element-ui el-dialog组件应用总结 <a class="header-anchor" href="#element-ui-el-dialog组件应用总结" aria-label="Permalink to &quot;Element-ui el-dialog组件应用总结&quot;">​</a></h1><h2 id="场景一" tabindex="-1">场景一 <a class="header-anchor" href="#场景一" aria-label="Permalink to &quot;场景一&quot;">​</a></h2><p>需求：</p><p>实现活动：新增、查询、编辑、删除。</p><p>实现服务器：新增、查询、编辑、删除。</p><p>新增活动需要选择对应的服务器。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;page&gt;</span></span>
